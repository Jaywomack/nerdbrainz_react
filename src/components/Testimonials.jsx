        ...
        <div class="flex flex-wrap -m-4">
          <div class="p-4 md:w-1/2 w-full">
            <div class="h-full bg-gray-100 p-8 rounded">
              ...
              <p class="leading-relaxed mb-6">
                My e-commerce site was up and running in no time. I am making
                sales within two weeks of talking to Alex about the site. These
                guys are professional, fast and amazing at what they do!
              </p>
              <a class="inline-flex items-center" href="#">
                ...
                <span class="flex-grow flex flex-col pl-4">
                  <span class="title-font font-medium text-gray-900">Kim</span>
          ...
          <div class="p-4 md:w-1/2 w-full">
            <div class="h-full bg-gray-100 p-8 rounded">
              ...
              <p class="leading-relaxed mb-6">
                ...
                consulting other coffee shop owners to help them find success
                and doubled my income in the process.
              </p>
              <a class="inline-flex items-center" href="#">
                <img
                  alt="testimonial"
                ...
                <span class="flex-grow flex flex-col pl-4">
                  ...
                  <span class="text-gray-500 text-sm">Coffee Shop Owner</span>
                </span>
              </a>
            </div>
          </div>
          <div class="p-4 md:w-1/2 w-full">
            <div class="h-full bg-gray-100 p-8 rounded">
              ...
              <a class="inline-flex items-center" href="#">
                ...
                />
                <span class="flex-grow flex flex-col pl-4">
                  <span class="title-font font-medium text-gray-900">Ron</span>
                  <span class="text-gray-500 text-sm">
          ...
          <div class="p-4 md:w-1/2 w-full">
            <div class="h-full bg-gray-100 p-8 rounded">
              ...
              <p class="leading-relaxed mb-6">
                Delivered a project much better than expected. The website site
                is perfect and the experience could not have been better. From
                logo and color scheme to delivery and deployment these guys were
                amazing to deal with. I love my new site.
              </p>
              <a class="inline-flex items-center" href="#">
                <img
                  alt="testimonial"
                ...
                />
                <span class="flex-grow flex flex-col pl-4">
                  <span class="title-font font-medium text-gray-900">Tami</span>
                  <span class="text-gray-500 text-sm">
